...
$conf{'spam_message'} = 'Send error.<br />It is not possible to include a URL in the text.';

#04.sendmailのパス(サーバ会社へお問い合わせ下さい)
$conf{'sendmail'} = '/usr/sbin/sendmail';

#06.設置者のアドレス(カンマ区切り)
#$conf{'mailto'} = 'info@smartmedical.jp';
$conf{'mailto'} = 'okumura@i-clip.co.jp';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = '/contact2.html';

#08.設置者に届くメールの件名
$conf{'subject'} = 'from mailform';

#09.送信者に届くメールの件名
$conf{'res_subject'} = 'Thank you for contacting us.';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
Thank you for contacting us.
A staff in charge will get in touch with you shortly.


===sentence that you have sent========================
<resbody>
======================================================

If you were not aware that you were going to receive this email, 
please contact info@smartmedical.jp.

Best regards,
Smartmedical Corp.

----------------------------------------------------
    Smartmedical Corp.  < info@smartmedical.jp >
    official web site URL : http://smartmedical.jp/
----------------------------------------------------
